...
def str_to_pandas(interval: str) -> str:
    ...
    Pandas: https://pandas.pydata.org/pandas-docs/stable/user_guide/timeseries.html#dateoffset-objects, https://pandas.pydata.org/docs/user_guide/timeseries.html#offset-aliases
    """
    if "m" in interval:
